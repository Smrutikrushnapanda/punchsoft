        ...
        <div className="grid grid-cols-12 pb-10 gap-8 items-center">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              In the context of exams, value-added services could refer to
              additional offerings that enhance the exam experience. This might
              include instant result processing, detailed performance analytics,
              digital certificates, or even career counselling based on exam
              results. These services add value by providing students with more
              than just a simple exam score.
            </p>
