        ...
        <div className="grid grid-cols-12 pb-10 gap-8 items-center">
          ...
          <div className="col-span-12 md:col-span-6">
            ...
            <p className="text-gray-700 leading-relaxed text-justify">
              Exam infrastructure refers to the physical and technological
              resources needed to conduct exams. This includes well-ventilated
              examination halls, comfortable seating arrangements, proper
              lighting, and up-to-date computer systems for online exams.
            </p>
